...
person1.innerHTML = ' <div class="modal-content">    <h1> Person 1 </h1>  <span class="close">&times;</span>      <div class="modalGrid">        <div class="div1">          <h1>Name, Nachname</h1>          <form id="newPersonModal">            <label for="firstName">Vorname:</label>            <input type="text" id="firstName1" name="firstName">            <br><br>            <label for="familyName">Nachname:</label>            <input type="text" id="familyName1" name="familyName">          </form>        </div>        <div class="div2">          <h1>Mutter, Vater, Ehepartner</h1>          <label for="mother">WÃ¤hlen Sie die Mutter aus:</label>          <select name="mother" id="mother1" form="newPersonModal">            <option value="unknown"> ? </option>            <option value="xxxx">xxxx</option>          </select>          <br><br>          <label for="father">WÃ¤hlen Sie den Vater aus:</label>          <select name="father" id="father1" form="newPersonModal">            <option value="unknown"> ? </option>            <option value="xxxx">xxxx</option>          </select>          <br><br>          <label for="spouse">WÃ¤hlen Sie den Ehepartner aus:</label>          <select name="spouse" id="spouse1" form="newPersonModal">            <option value="none">-</option>            <option value="xxxx">xxxx</option>          </select>        </div>        <div class="div3">          <h1>Geburtsort, Geburtsdatum, Todesdatum</h1>          <label for="birthPlace">Geburtsort:</label>          <input type="text" id="birthPlace1" name="birthPlace" form="newPersonModal">          <br><br>          <label for="birthdate">Geburtsdatum:</label>          <input type="date" id="birthdate1" name="birthdate">          <br><br>          <label for="deathDate">Todesdatum:</label>          <input type="date" id="deathDate1" name="deathDate">        </div>      </div>    </div>  ';

var person1 = document.getElementById("person 2");
person1.innerHTML = ' <div class="modal-content">    <h1> Person 2 </h1>  <span class="close">&times;</span>      <div class="modalGrid">        <div class="div1">          <h1>Name, Nachname</h1>          <form id="newPersonModal1">            <label for="firstName">Vorname:</label>            <input type="text" id="firstName2" name="firstName">            <br><br>            <label for="familyName">Nachname:</label>            <input type="text" id="familyName2" name="familyName">          </form>        </div>        <div class="div2">          <h1>Mutter, Vater, Ehepartner</h1>          <label for="mother">WÃ¤hlen Sie die Mutter aus:</label>          <select name="mother" id="mother2" form="newPersonModal">            <option value="unknown"> ? </option>            <option value="xxxx">xxxx</option>          </select>          <br><br>          <label for="father">WÃ¤hlen Sie den Vater aus:</label>          <select name="father" id="father2" form="newPersonModal">            <option value="unknown"> ? </option>            <option value="xxxx">xxxx</option>          </select>          <br><br>          <label for="spouse">WÃ¤hlen Sie den Ehepartner aus:</label>          <select name="spouse" id="spouse2" form="newPersonModal">            <option value="none">-</option>            <option value="xxxx">xxxx</option>          </select>        </div>        <div class="div3">          <h1>Geburtsort, Geburtsdatum, Todesdatum</h1>          <label for="birthPlace">Geburtsort:</label>          <input type="text" id="birthPlace2" name="birthPlace" form="newPersonModal">          <br><br>          <label for="birthdate">Geburtsdatum:</label>          <input type="date" id="birthdate2" name="birthdate">          <br><br>          <label for="deathDate">Todesdatum:</label>          <input type="date" id="deathDate2" name="deathDate">        </div>      </div>    </div>  ';
*/
